...
// main.ts
__export(exports, {
  default: () => SimpleNoteQuizPlugin
});
var import_obsidian4 = __toModule(require("obsidian"));

// component/quiz-modal.tsx
var import_obsidian2 = __toModule(require("obsidian"));
var React2 = __toModule(require_react());
var ReactDOM = __toModule(require_react_dom());

// component/react-card.tsx
...
var wrongMark = "\u274C";
var mode_all_id = 0;
var mode_unMarked_id = 1;
var mode_wrongOnes_id = 2;
var mode_clearAll_id = 3;
var mode_nothing_id = -1;
var mode_all_title = "Review all";
var mode_unMarked_title = "Review unmarked";
var mode_wrongOnes_title = "Review the wrong ones";
var mode_clearAll_title = "Clear all marks";
...
function ReactCard(props) {
  ...
  React.useEffect(() => {
    ...
    import_obsidian.MarkdownRenderer.renderMarkdown(cards[currentCardNum].question, questionContainerRef.current, plugin.app.workspace.getActiveFile(), plugin);
  ...
  const renderAnswerArea = () => {
    ...
    import_obsidian.MarkdownRenderer.renderMarkdown(cards[currentCardNum].answer, answerContainerRef.current, plugin.app.workspace.getActiveFile(), plugin);
    answerContainerRef.current.findAll(".internal-embed").forEach((ele) => {
      renderImages(ele);
    });
  };
  const renderImages = (ele) => {
    const source = ele.getAttribute("src");
    const imageSource = getImageSource(source);
    if (imageSource) {
      answerContainerRef.current.createEl("img", { attr: { src: imageSource } }, (img) => {
  ...
  const renderSummary = () => {
    return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h3", null, "You finished the quiz\u{1F44F} ! You got ", rightAnswerNum, " out of ", cards.length, " questions right!"), /* @__PURE__ */ React.createElement("h3", null, " Would you like to make the marks?"), /* @__PURE__ */ React.createElement("div", {
      className: "quiz__container__checkmark__container"
  ...
  return /* @__PURE__ */ React.createElement("div", {
    ref: wrapperRef
  }, isEnd() ? renderSummary() : /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("h3", null, "Current progress: ", currentCardNum + 1, "/", numOfCards), /* @__PURE__ */ React.createElement("div", {
    ref: questionContainerRef
  }), !showAnswer && /* @__PURE__ */ React.createElement("button", {
    className: "show-answer-btn",
    onClick: () => renderAnswerArea()
  }, "Show Answer"), /* @__PURE__ */ React.createElement("div", {
    ref: answerContainerRef,
    tabIndex: -1
  }), showAnswer && /* @__PURE__ */ React.createElement("div", {
    className: "quiz__container__checkmark__container"
  }, /* @__PURE__ */ React.createElement("button", {
    onClick: () => renderNextCardCleanUp("yes")
  }, `Correct ${correctMark}`), /* @__PURE__ */ React.createElement("button", {
    onClick: () => renderNextCardCleanUp("no")
  }, `Wrong ${wrongMark}`))));
}

// config/constants.ts
var questionSeparatorOptions = {
  NEW_LINE: "new-line",
...
var Suggestions = class extends import_obsidian2.SuggestModal {
  ...
  getSuggestions(query) {
    return ALL_Modes.filter((mode) => mode.title.toLowerCase().includes(query.toLowerCase()));
  }
  renderSuggestion(mode, el) {
    el.createEl("div", { text: mode.title });
    el.createEl("small", { text: mode.description });
  }
  onChooseSuggestion(mode, evt) {
    return new QuizModal(this.app, mode.id, this.settings).open();
  }
};
var QuizModal = class extends import_obsidian2.Modal {
  constructor(app, mode, settings) {
    super(app);
    this.recordResponse = (updatedCards) => {
  ...
  onOpen() {
    return __async(this, null, function* () {
      ...
      const lines = yield this.processFileText();
      if (!lines) {
      ...
      if (cards.length === 0) {
        ...
        ReactDOM.render(/* @__PURE__ */ React2.createElement(ReactCard, {
          cards,
          plugin: this,
  ...
  processFileText() {
    return __async(this, null, function* () {
      let fileText = yield this.app.vault.read(this.file);
  ...
  generateNotice(mode = mode_nothing_id) {
    if (mode === mode_clearAll_id) {
      return new import_obsidian2.Notice("Cleared all your previous marks!");
    } else if (mode === mode_nothing_id) {
      return new import_obsidian2.Notice("You have nothing to quiz!");
    }
    return;
  }
  shuffleCards(array) {
...
var Card = class {
  constructor(question, answer, lineNumber) {
...
var SimpleNoteQuizPluginSettingTab = class extends import_obsidian3.PluginSettingTab {
  ...
  createRandomizeQuestionSetting(containerEl) {
    new import_obsidian3.Setting(containerEl).setName("Randomize questions?").setDesc("If toggled, the cards will be displayed in random order").addToggle((toggle) => {
      toggle.setValue(this.plugin.settings.randomizeQuestionSetting).onChange((value) => __async(this, null, function* () {
        this.plugin.settings.randomizeQuestionSetting = value;
        yield this.plugin.saveSettings();
      }));
    });
  }
  createQuestionSeparatorDropdownSetting(containerEl) {
    new import_obsidian3.Setting(containerEl).setName("Question separator").setDesc("How the plugin separates questions").addDropdown((dropdown) => {
      dropdown.addOption(questionSeparatorOptions.NEW_LINE, "New line").addOption(questionSeparatorOptions.NEW_BULLET_POINT, "New unindented bullet point").setValue(this.plugin.settings.questionSeparatorSetting).onChange((value) => __async(this, null, function* () {
        this.plugin.settings.questionSeparatorSetting = value;
        yield this.plugin.saveSettings();
      }));
    });
  }
  createQuestionMarkSetting(containerEl) {
    new import_obsidian3.Setting(containerEl).setName("Question mark").setDesc("The plugin will recognize lines with the mark as questions").addText((text) => text.setValue(this.plugin.settings.questionMarkSetting).onChange((value) => __async(this, null, function* () {
      if (!!value) {
        this.plugin.settings.questionMarkSetting = value;
        yield this.plugin.saveSettings();
      }
    }))).addExtraButton((button) => {
      button.setIcon("reset").setTooltip("Reset default").onClick(() => __async(this, null, function* () {
...
// main.ts
var SimpleNoteQuizPlugin = class extends import_obsidian4.Plugin {
  onload() {
    return __async(this, null, function* () {
      yield this.loadSettings();
      const ribbonIconEl = this.addRibbonIcon("checkbox-glyph", "Quiz you note", (evt) => {
        new Suggestions(this.app, this.settings).open();
      });
