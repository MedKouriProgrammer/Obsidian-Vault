...
created: 2023-03-15T20:47
updated: 2024-06-08T22:29
---
Links: [[Monthly Reviews]]
___
# 2023-M03
<< [[2023-M02]] | [[2023-M03]] | [[2023-M04]] >>
...
mode:: [[Mode/Life🏠]] 
kind:: [[Reviews/Monthly🌔]] 
status:: [[Status/Blank⚪]] 
summary:: Monthly Review for last month 2023-02 and what to keep in mind for this month 2023-03
...
# Task List
- ## Home
	- [ ] [[Monthly Academic Report - Mar 2023]]
- ## Home
	- [ ] What have I done this month
	- [ ] Draw a Monthly Spread
	- [ ] Goals for next month

# Summary of Last Month March 2023

## Weeks of The Month
```dataview
list
FROM [[Periodic/Weekly📆]]  and [[2023-M03]]
WHERE parent=[[2023-M03]]
```
## Memories
```dataview
...
FROM [[Periodic/Weekly📆]]  and [[2023-M03]]
WHERE parent=[[2023-M03]] and weekly_work_summary 
SORT file.day DESC
```
...
FROM [[Periodic/Weekly📆]]  and [[2023-M03]]
WHERE parent=[[2023-M03]] and weekly_youtube_summary 
SORT file.day DESC
```
...
WHERE file.ctime >= date(2023-03-13)-dur(1 month) and file.ctime <= date(2023-03-13)
SORT file.name ASC
```
...
FROM [[Periodic/Weekly📆]]  and [[2023-M03]]
WHERE parent=[[2023-M03]] and weekly_progression_summary 
SORT file.day DESC
```
...
FROM [[Periodic/Weekly📆]]  and [[2023-M03]]
WHERE parent=[[2023-M03]] and weekly_reflection_summary 
SORT file.day DESC
```
