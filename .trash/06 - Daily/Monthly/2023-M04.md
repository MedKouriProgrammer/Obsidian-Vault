...
# Task List
- ## Home
	- [ ] [[Monthly Academic Report - Apr 2023]]
- ## Home
	- [ ] What have I done this month
	- [ ] Draw a Monthly Spread
	- [ ] Goals for next month

# Summary of Last Month April 2023

## Weeks of The Month
```dataview
list
FROM [[Reviews/Weekly📆]] and [[2023-M04]]
WHERE parent=[[2023-M04]]
```
## Memories
```dataview
...
FROM [[Reviews/Weekly📆]] and [[2023-M04]]
WHERE parent=[[2023-M04]] and weekly_work_summary 
SORT file.day DESC
```
...
FROM [[Reviews/Weekly📆]]  and [[2023-M04]]
WHERE parent=[[2023-M04]] and weekly_youtube_summary 
SORT file.day DESC
```
...
energy AS "⚡"
FROM [[Reviews/Daily📅]] 
WHERE file.ctime >= date(2023-04-17)-dur(1 month) and file.ctime <= date(2023-04-17)
SORT file.name ASC
```
...
FROM [[Reviews/Weekly📆]]   and [[2023-M04]]
WHERE parent=[[2023-M04]] and weekly_progression_summary 
SORT file.day DESC
```
...
FROM [[Reviews/Weekly📆]]   and [[2023-M04]]
WHERE parent=[[2023-M04]] and weekly_reflection_summary 
SORT file.day DESC
```
