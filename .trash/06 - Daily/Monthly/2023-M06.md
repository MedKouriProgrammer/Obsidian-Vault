...
# Task List
- ## Home
	- [ ] [[Monthly Academic Report - Jun 2023]]
- ## Home
	- [ ] What have I done this month
	- [ ] Draw a Monthly Spread
	- [ ] Goals for next month

# Summary of Last Month June 2023

## Weeks of The Month
```dataview
list
FROM [[Reviews/Weekly📆]] and [[2023-M06]]
WHERE parent=[[2023-M06]]
```
## Memories
```dataview
...
FROM [[Reviews/Weekly📆]] and [[2023-M06]]
WHERE parent=[[2023-M06]] and weekly_work_summary 
SORT file.day DESC
```
...
FROM [[Reviews/Weekly📆]]  and [[2023-M06]]
WHERE parent=[[2023-M06]] and weekly_youtube_summary 
SORT file.day DESC
```
...
energy AS "⚡"
FROM [[Reviews/Daily📅]] 
WHERE file.ctime >= date(2023-06-26)-dur(1 month) and file.ctime <= date(2023-06-26)
SORT file.name ASC
```
...
FROM [[Reviews/Weekly📆]]   and [[2023-M06]]
WHERE parent=[[2023-M06]] and weekly_progression_summary 
SORT file.day DESC
```
...
FROM [[Reviews/Weekly📆]]   and [[2023-M06]]
WHERE parent=[[2023-M06]] and weekly_reflection_summary 
SORT file.day DESC
```
