...
# <font color="#646a73">Utility Library: Abu-Hedhoud Solution</font> 
---
...
```
### <font color="#ffff00">Input: clsString</font> 
```cpp
#pragma once
...
```
### <font color="#ffff00">Input: clsDate</font>
```cpp
#pragma once
...
```
### <font color="#ffff00">Input: clsInputValidate</font>
```cpp
#pragma once
#include <iostream>
#include <string>
