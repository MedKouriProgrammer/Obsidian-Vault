...
class clsDeveloper : public clsEmployee {
    ...
    public:
    clsDeveloper(int ID, string FirstName, string LastName, string Email, string Phone, string Title, string Department, bool Salary, string MainProgrammingLanguage)
    :clsEmployee(ID, FirstName, LastName, Email, Phone, Title, Department, Salary) {
        _MainProgrammingLanguage = MainProgrammingLanguage;
    }

    string SetMainProgrammingLanguage(string MainProgrammingLanguage) {
        return _MainProgrammingLanguage = MainProgrammingLanguage;
    }
...
int main() {
    ...
    clsDeveloper Developer1(10, "Zakaria", "Medkouri", "my@gmail.com", "06213547", "CEO", "ProgrammingAdvices", 5000, "C++");
