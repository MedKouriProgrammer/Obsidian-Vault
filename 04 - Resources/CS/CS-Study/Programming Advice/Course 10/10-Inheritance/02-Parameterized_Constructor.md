...
# <font color="#646a73">Parameterized Constructor</font>
---
![[Screenshot_20260420-140934_Moon+ Reader Pro.jpg]]
...
int main() {
    ...
    clsEmployee Employee(10, "Zakaria", "Medkouri", "my@gmail.com", "06213547", "CEO", "ProgrammingAdvices", 5000);
    Employee.Print();

    cout << "\nTitle is: " << Employee.Title();
...
Title is: CEO
Department is: ProgrammingAdvices
Salary is: 1
```